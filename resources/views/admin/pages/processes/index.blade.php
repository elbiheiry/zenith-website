...
@section('content')
    ...
    <div class="page-content">
        <div class="widget">
            <div class="widget-title"> Add process</div>
            <div class="widget-content">
                <form method="post" action="{{ route('admin.processes.store') }}" class="ajax-form">
                    @csrf
                    @method('post')
                    <div class="row">
                        <div class="col-6">
        ...
        <div class="widget">
            ...
            <div class="widget-content">
                @php
                    $x = 1;
                @endphp
                @foreach ($processes['data'] as $index => $process)
                    <div class="slide_item">
                        <img src="{{ $process['image'] }}" />
                        <div class="slide_cont">
                            <span> #{{ $x }} </span>
                            <h3>{{ $process['title_en'] }}</h3>
                            <div class="w-100">
                                <a class="custom-btn" href="{{ route('admin.processes.edit', ['id' => $process['id']]) }}">
                                    <i class="fa fa-edit"></i> Edit
                                </a>
                                <button class="custom-btn red-bc delete-btn"
                                    data-url="{{ route('admin.processes.delete', ['id' => $process['id']]) }}"
