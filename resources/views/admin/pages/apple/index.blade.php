    ...
    <div class="page-content">
        <div class="widget">
            ...
            <div class="widget-content">
                <form method="put" action="{{ route('admin.apple.update2') }}" class="ajax-form">
                    @csrf
                    @method('put')
                    <div class="row">
                        <div class="col-6">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control font_ar" name="title_ar"
                                    value="{{ $apple['title_ar'] }}" />
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                <label> description (EN)</label>
                                <textarea class="form-control" name="description_en">{{ $apple['description_en'] }}</textarea>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                <label> description (AR)</label>
                                <textarea class="form-control" name="description_ar">{{ $apple['description_ar'] }}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="col-12">
        ...
        <div class="widget">
            ...
            <div class="widget-content">
                <form method="post" action="{{ route('admin.apple.store') }}" class="ajax-form">
                    @csrf
                    @method('post')
                    <div class="row">
                        <div class="col-6">
                ...
                @foreach ($contents['data'] as $index => $content)
                    <div class="slide_item">
                        ...
                        <div class="slide_cont">
                            ...
                            <div class="w-100">
                                <a class="custom-btn" href="{{ route('admin.apple.edit', ['id' => $content['id']]) }}">
                                    <i class="fa fa-edit"></i> Edit
                                </a>
                                <button class="custom-btn red-bc delete-btn"
                                    data-url="{{ route('admin.apple.delete', ['id' => $content['id']]) }}"
