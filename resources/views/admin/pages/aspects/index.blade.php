    ...
    <div class="page-content">
        <div class="widget">
            ...
            <div class="widget-content">
                <form method="put" action="{{ route('admin.aspects.update2') }}" class="ajax-form">
                    @csrf
                    @method('put')
                    <div class="row">
                        <div class="col-6">
        ...
        <div class="widget">
            <div class="widget-title"> Aspect</div>
            <div class="widget-content">
                <form method="post" action="{{ route('admin.aspects.store') }}" class="ajax-form">
                    @csrf
                    @method('post')
                    <div class="row">
                        <div class="col-6">
                ...
                @foreach ($images['data'] as $index => $image)
                    <div class="slide_item">
                        ...
                        <div class="slide_cont">
                            <span> #{{ $x }} </span>
                            <div class="w-100">
                                <a class="custom-btn" href="{{ route('admin.aspects.edit', ['id' => $image['id']]) }}">
                                    <i class="fa fa-edit"></i> Edit
                                </a>
                                <button class="custom-btn red-bc delete-btn"
                                    data-url="{{ route('admin.aspects.delete', ['id' => $image['id']]) }}"
