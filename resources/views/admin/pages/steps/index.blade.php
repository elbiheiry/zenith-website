...
@section('content')
    ...
    <div class="page-content">
        <div class="widget">
            <div class="widget-title"> Add step</div>
            <div class="widget-content">
                <form method="post" action="{{ route('admin.steps.store') }}" class="ajax-form">
                    @csrf
                    @method('post')
                    <div class="row">
                        <div class="col-6">
                ...
                @foreach ($steps['data'] as $index => $step)
                    <div class="slide_item">
                        ...
                        <div class="slide_cont">
                            ...
                            <h3>{{ $step['title_en'] }}</h3>
                            <div class="w-100">
                                <a class="custom-btn" href="{{ route('admin.steps.edit', ['id' => $step['id']]) }}">
                                    <i class="fa fa-edit"></i> Edit
                                </a>
                                <button class="custom-btn red-bc delete-btn"
                                    data-url="{{ route('admin.steps.delete', ['id' => $step['id']]) }}"
