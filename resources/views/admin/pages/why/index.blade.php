    ...
    <div class="page-content">
        <div class="widget">
            ...
            <div class="widget-content">
                <form method="post" action="{{ route('admin.why.store') }}" class="ajax-form">
                    @csrf
                    @method('post')
                    <div class="row">
                        <div class="col-6">
                ...
                @foreach ($data['data'] as $index => $item)
                    <div class="slide_item">
                        ...
                        <div class="slide_cont">
                            ...
                            <h3>{{ $item['title_en'] }}</h3>
                            <div class="w-100">
                                <a class="custom-btn" href="{{ route('admin.why.edit', ['id' => $item['id']]) }}">
                                    <i class="fa fa-edit"></i> Edit
                                </a>
                                <button class="custom-btn red-bc delete-btn"
                                    data-url="{{ route('admin.why.delete', ['id' => $item['id']]) }}"
