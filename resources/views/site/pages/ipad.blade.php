        ...
        <div class="container">
            <div class="row">
                <div class="col-12 d-flex justify-content-between align-items-center">
                    <h3>{{ locale() == 'en' ? 'iPad In Education' : 'ipad في التعليم' }}</h3>
                    <ul>
                        ...
                        <li>{{ locale() == 'en' ? 'iPad In Education' : 'ipad في التعليم' }}</li>
                    </ul>
                </div>
                <!--End Col-->
            </div>
        ...
        <div class="container">
            @foreach ($ipads['data'] as $ipad)
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-6" data-aos="fade-up" data-aos-delay="40">
                        <div class="text">
                            <h3>{{ $ipad['title_' . locale()] }}</h3>
                            @foreach (explode("\n", $ipad['description_' . locale()]) as $item)
                                <p>{{ $item }}</p>
                            @endforeach
                        </div>
                    </div>
